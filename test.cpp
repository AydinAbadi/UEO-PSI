...
ll= (mpz_t*)malloc(4*sizeof(mpz_t));

mpz_init_set_str(ll[0],"120",10);
mpz_init_set_str(ll[1],"7832",10);
mpz_init_set_str(ll[2],"3745",10);
mpz_init_set_str(ll[3],"7545",10);
mpz_init_set_str(ll[4],"5643",10);
mpz_init_set_str(ll[5],"56421",10);

Hashtable ht(2,ll,6,5);
